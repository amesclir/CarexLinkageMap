...
Now we are going to look for markers with a higher number than markers under segregation distortion that what would be expected by chance.
...
plot(x2 ~ missingdata, main="Correlation between segregation distortion (X-square) and missing data", xlab = "Number of individuals missing the marker", ylab = "Segregation distortion (X-square)")
...
Now we are going to check whether or not those markers under segregation distortion are gouped together within the linkage groups.
...
missingdata <- LG31[,4]
summary(lm(x2 ~ missingdata))
plot(x2 ~ missingdata, main="Correlation between segregation distortion (X-square) and missing data in LG31", xlab = "Number of individuals missing the marker", ylab = "Segregation distortion (X-square)")
...
missingdata <- LG17[,4]
summary(lm(x2 ~ missingdata))
plot(x2 ~ missingdata, main="Correlation between segregation distortion (X-square) and missing data in LG17", xlab = "Number of individuals missing the marker", ylab = "Segregation distortion (X-square)")
...
missingdata <- LG13[,4]
summary(lm(x2 ~ missingdata))
plot(x2 ~ missingdata, main="Correlation between segregation distortion (X-square) and missing data in LG13", xlab = "Number of individuals missing the marker", ylab = "Segregation distortion (X-square)")
...
LG31CIsup <- vector()
for (i in 1:9) LG31CIsup[i] <- quantile(as.numeric(LG31.1000[i,4:1003]), 0.95)
LG31$CIsup <- LG31CIsup
LG31$CIinf <- 0
...
LG17CIsup <- vector()
for (i in 1:90) LG17CIsup[i] <- quantile(as.numeric(LG17.1000[i,4:1003]), 0.95)
LG17$CIsup <- LG17CIsup
LG17$CIinf <- 0
...
LG13CIsup <- vector()
for (i in 1:28) LG13CIsup[i] <- quantile(as.numeric(LG13.1000[i,4:1003]), 0.95)
LG13$CIsup <- LG13CIsup
LG13$CIinf <- 0
