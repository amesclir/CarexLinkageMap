...
library(ggplot2)
p31.sd <- ggplot(LG31.sd, aes(POSITION))+
  geom_line(data=subset(LG31.sd),aes(y=CHISQUARE),col="black",width=1,linetype="dotted")+
  geom_point(data=subset(LG31.sd),aes(y=CHISQUARE),col="black")+
  scale_y_continuous(limits = c(0, 15))+
  geom_ribbon(data=subset(LG31),aes(ymin=CIinf,ymax=CIsup),alpha=0.5,fill="grey")+
  geom_errorbar(data=subset(LG31),aes(ymin=CHISQUARE,ymax=CHISQUARE),width=1)+
  theme_bw(base_size=30)+
